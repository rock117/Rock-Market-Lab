...
pub struct Model {
    ...
    #[serde(rename = "conv_copbonds_due_within_1y")]
    pub conv_copbonds_due_within_y1: Option<Decimal>,
...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::ConvCopbondsDueWithinY1 => ColumnType::Decimal(None).def().null(),
