...
pub async fn list_strategy_templates_handler() -> Result<WebResponse<Vec<StrategyTemplateDto>>> {
    let templates = vec![
        ...
        StrategyTemplateDto {
            template: "low_turnover_dividend_roe_smallcap".to_string(),
            label: "低换手高股息高ROE小市值策略".to_string(),
            description: "过去N天低换手、温和上涨，高股息率(dv_ttm)、高ROE、小市值".to_string(),
            params: vec![
                StrategyTemplateParam {
                    key: "lookback_days".to_string(),
                    label: "回看天数".to_string(),
                ...
                StrategyTemplateParam {
                    key: "max_avg_turnover_rate".to_string(),
                    label: "最大平均换手率(%)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                ...
                StrategyTemplateParam {
                    key: "min_dv_ttm".to_string(),
                    label: "最小股息率(%)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                    default_value: Some(serde_json::json!(3.0)),
                    description: None,
                ...
                StrategyTemplateParam {
                    key: "max_market_cap_yi".to_string(),
                    label: "最大市值(亿)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                    default_value: Some(serde_json::json!(200.0)),
                    description: None,
                    min: Some(0.0),
                    max: Some(100000.0),
                    options: None,
        ...
        StrategyTemplateDto {
            template: "rise_range_consolidation".to_string(),
            label: "区间涨幅+前置横盘策略".to_string(),
            description: "前置M天横盘(收盘振幅约束)，过去N天每日涨跌幅在区间内且累计涨幅在区间内；按市值/ROE/股息率TTM加权排序".to_string(),
            params: vec![
                StrategyTemplateParam {
                    key: "lookback_days".to_string(),
                    label: "回看天数(N)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                    default_value: Some(serde_json::json!(20)),
                    description: None,
                ...
                StrategyTemplateParam {
                    key: "pre_amplitude_max_pct".to_string(),
                    label: "前置横盘最大振幅(%)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                    default_value: Some(serde_json::json!(5.0)),
                    description: None,
                ...
                StrategyTemplateParam {
                    key: "weight_market_cap".to_string(),
                    label: "权重-市值(越小越好)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                ...
                StrategyTemplateParam {
                    key: "weight_roe".to_string(),
                    label: "权重-ROE(越高越好)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                ...
                StrategyTemplateParam {
                    key: "weight_dv_ttm".to_string(),
                    label: "权重-股息率TTM(越高越好)".to_string(),
                    r#type: "number".to_string(),
                    required: true,
                    default_value: Some(serde_json::json!(0.3)),
                    description: None,
