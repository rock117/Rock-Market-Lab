    ...
    fn test_calculate_trend_score_with_more_data() {
        ...
        for i in 0..10 {
            data.push(SecurityData {
                ...
                pre_close: Some(10.0 + i as f64 * 0.1),
                change: Some(0.2),
                pct_change: Some(2.0),
                volume: 1000000.0,
                amount: 10200000.0,
