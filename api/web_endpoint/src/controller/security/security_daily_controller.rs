...
pub async fn get_security_price(r#type: &str, ts_code: &str, start: &str, end: &str, conn: &State<DatabaseConnection>) ->  crate::result::Result<WebResponse<Vec<SecurityDaily>>> {
